About dynare-preprocessor-feedstock
===================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/dynare-preprocessor-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dynare-preprocessor-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add dynare-preprocessor
# for installing globally
pixi global install dynare-preprocessor
```
...
It is possible to list all of the versions of `dynare-preprocessor` available on your platform:
...
```
pixi search dynare-preprocessor --channel conda-forge
```
